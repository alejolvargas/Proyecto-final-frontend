...
import { resetearPagina } from "../redux/actions/pagina.action";
import { limpiarFavoritos } from "../redux/actions/personaje.actions";
  ...
  return (
    <div className="container">
      <div className="actions">
        ...
        <button
          className={favoritosId.length === 0 ? "primary" : "danger"}
          disabled={favoritosId.length === 0}
